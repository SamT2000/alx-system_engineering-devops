0x0A. Configuration management By Sylvain Kalache Weight: 1 Background Context
...
Install puppet $ apt-get install -y ruby=1:2.7+1 --allow-downgrades $ apt-get install -y ruby-augeas $ apt-get install -y ruby-shadow $ apt-get install -y puppet
...
Tasks 0. Create a file mandatory
